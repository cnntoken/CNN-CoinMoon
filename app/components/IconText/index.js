...
const iconType = {
    ...
    comment_small: require('app/images/icon_comment_small.png'),
    comment_big: require('app/images/icon_comment_big.png'),
    like_small: require('app/images/icon_like_small.png'),
    like_big: require('app/images/icon_like_big.png'),
    liked_small: require('app/images/icon_liked_small.png'),
    liked_big: require('app/images/icon_liked_big.png'),
